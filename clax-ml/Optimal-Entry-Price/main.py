...
async def optimal_entry_exit_price(request: OptimalSignalRequest):
    """
...
async def schedule_training(background_tasks: BackgroundTasks):
    """
...
async def trigger_data_loaders(background_tasks: BackgroundTasks):
    """
...
async def trigger_feature_engineering(background_tasks: BackgroundTasks):
    """
...
async def trigger_train_model(background_tasks: BackgroundTasks):
    """
