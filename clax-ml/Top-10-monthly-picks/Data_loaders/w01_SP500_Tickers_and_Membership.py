# clax-ml/Top-10-monthly-picks/Data_loaders/w01_SP500_Tickers_and_Membership.py
...
DEFAULT_MEMBERSHIP_FILENAME = "outputs/01_SP500_membership_matrix.csv"
...
def build_membership_matrix(
    tickers: List[str],
    filename: str = DEFAULT_MEMBERSHIP_FILENAME,
